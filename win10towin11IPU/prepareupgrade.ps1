...
# Run the script
start-windowssetup -downloadUrl [uri]$downloadUrl -quiet [bool]$quiet -SkipFinalize [bool]$SkipFinalize -Finalize [bool]$Finalize -ScanOnly [bool]$ScanOnly -dynamicUpdate [bool]$dynamicUpdate